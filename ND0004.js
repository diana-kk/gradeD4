...
var girl = Paper.image('img/girl.png', 0, 0, 300, 105).toDefs();
...
girl.use().transform('t25, 220').appendTo(topArea);

topArea.text(150, 297, 'D01 ~ 03').attr({
  'font-size': 30
});
...
function handler01() {
  location.replace('ND0004_01.html');
}
